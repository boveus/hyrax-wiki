A list of resources related to the Portland Common Data Model (PDCM) and its implementation in Hyrax
...
* [List of tickets](https://github.com/projecthydra-labs/hyrax/issues?q=is%3Aopen+is%3Aissue+milestone%3A%22May+Hydra+PCDM%22) to be worked on during the Sprint in May. You can also look at them via the [Waffle board](https://waffle.io/projecthydra-labs/hyrax?milestone=May%20Hydra%20PCDM). 
